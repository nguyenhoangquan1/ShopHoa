...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 06, 2020 lúc 10:48 AM
...
--
-- Cơ sở dữ liệu: `shopbanhangdb.sql`
--
...
CREATE TABLE `dangki` (
  ...
  `dienthoai` varchar(100) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `dangki` (`id_kh`, `tenkh`, `email`, `matkhau`, `dienthoai`, `diachi`) VALUES
(2, 'Anh', 'meow@gmail.com', '123', '0938214753', '1587dhthQ12');
...
INSERT INTO `hoa_don` (`id`, `ten_nguoi_mua`, `email`, `dia_chi`, `dien_thoai`, `noi_dung`, `hang_duoc_mua`, `tong_cong`) VALUES
(1, 'Tao khong mua dau', 'taomua@gmail.yahoo', 'yahoo.com/gmail', '113', 'khong mua', '41 n 1__', '700000');
